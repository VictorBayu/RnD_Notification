...
function kirimTele($teleID, $pesan)
{
    $data = [
        'chat_id' => $teleID,
        'text' => $pesan,
    ...
    $url = "https://api.telegram.org/bot1389960601:AAGAAqmhYZQmbtfsVbRToncEb9ERr8l1IG4/sendMessage?".http_build_query($data);
    ...
    // echo "Pesan Telah Terkirim $teleID, $pesan <br>";
